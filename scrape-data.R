...
pithces_2015 = do.call(rbind, lapply(dates_2015, get_daily_pitches))
pithces_2016 = do.call(rbind, lapply(dates_2016, get_daily_pitches))
pithces_2017 = do.call(rbind, lapply(dates_2017, get_daily_pitches))
pithces_2018 = do.call(rbind, lapply(dates_2018, get_daily_pitches))
pithces_2019 = do.call(rbind, lapply(dates_2019, get_daily_pitches))
pithces_2020 = do.call(rbind, lapply(dates_2020, get_daily_pitches))
